...
INSERT INTO STUDENT (ID, lastname, firstname, emailAddress, studentId, status) VALUES (hibernate_sequence.nextval, 'ENROLLED', 'first1', 'first.last@domain.com', 1234, 0);

INSERT INTO STUDENT (ID, lastname, firstname, emailAddress, studentId, status) VALUES (hibernate_sequence.nextval, 'DROPPED_OUT', 'first2', 'first.last@domain.com', 1235, 1);

INSERT INTO STUDENT (ID, lastname, firstname, emailAddress, studentId, status) VALUES (hibernate_sequence.nextval, 'ALUMNI', 'first1', 'first.last@domain.com', 1236, 2);
INSERT INTO STUDENT (ID, lastname, firstname, emailAddress, studentId, status) VALUES (hibernate_sequence.nextval, 'ALUMNI', 'first2', 'first.last@domain.com', 1237, 2);
