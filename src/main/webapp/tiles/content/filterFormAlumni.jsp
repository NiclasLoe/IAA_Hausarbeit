...
<s:form>
    ...
    <s:submit key="button.applyFilter" action="applyFilterAlumni" cssClass="submitButton"/>
    <s:submit key="button.cancel" action="cancelAlumniFilter" cssClass="submitButton"/>
</s:form>
